namespace Rabbit.AspNetCore.Mvc.Extensions
{
    public static class ActionDescriptorExtensions
    {
        ...
        public static ControllerActionDescriptor AsControllerActionDescriptor(this ActionDescriptor actionDescriptor)
        {
            ...
            {
                throw new RabbitException($"变量`{nameof(actionDescriptor)}`非{typeof(ControllerActionDescriptor).AssemblyQualifiedName}类型");
            }
